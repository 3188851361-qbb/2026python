...
def use_rename():
    ...
    :return:
    """
    # os.rename('dir1\\file2', 'dir1\\file1')  # 用\容易与转义字符冲突
...
def use_dir_func():
    ...
    # os.rmdir('dir1')
    print(os.getcwd())
    os.chdir('dir2')   # 进入该目录，接下来所有操作是针对该目录而言，并且不会影响原当前目录
...
def scan_dir(current_path, width):
    ...
    for file in file_list:
        ...
        if os.path.isdir(new_path):    # 里面应该填的是文件路径而非文件名
